 ...
 *
 * @see {@link https://en.wikipedia.org/wiki/List_of_HTTP_status_codes Wiki - List of HTTP Status Codes}
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/HTTP/Status MDN - HTTP response status codes}
 * @see {@link https://gist.github.com/scokmen/f813c904ef79022e84ab2409574d1b45 HttpStatusCode.ts Source}
 */
